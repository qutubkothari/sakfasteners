...
Write-Host "[OK] Code updated on server" -ForegroundColor Green
...
Write-Host "[OK] Application restarted on port $PORT" -ForegroundColor Green
...
Write-Host "1. Configure nginx reverse proxy" -ForegroundColor Gray
Write-Host "2. Point domain to server" -ForegroundColor Gray
Write-Host "3. Setup SSL with certbot" -ForegroundColor Gray
Write-Host ""
