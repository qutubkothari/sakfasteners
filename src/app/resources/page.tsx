      ...
      <section className="grid gap-6 md:grid-cols-3">
        {articles.map((article) => (
          <div key={article.title} className="card-surface rounded-2xl p-6">
            ...
            <div className="mt-4">
              <button
                className="inline-flex items-center justify-center rounded-full bg-[var(--accent-strong)] px-5 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-[var(--accent)]"
              >
                {article.action}
              </button>
            </div>
